    ...
    <section class="dishes" id="dishes">
        ...
        <div class="box-container">
            @foreach( $menu as $menus)
                <div class="box">
                    <div class="image">
                        <img src="{{ (!empty($menus->image))? url('upload/menuitem_images/'.$menus->image):url('upload/no_image.jpg') }}" alt="">
                    ...
                    <div class="content">
                        ...
                        <a href="{{route('addtocart',$menus->id)}}" class="btn">add to cart</a>
                        <span class="price">M{{$menus->price}}</span>
                    </div>
                </div>
