...
@section('frontend')
            ...
            <div class="swiper-wrapper wrapper">
                ...
                <div class="swiper-slide slide">
                    <div class="content">
                        ...
                        <h3>spicy noodles</h3>
                        <p>Tokelo ipsum dolor sit amet consectetur adipisicing elit. Sit natus dolor cumque?</p>
                        <a href="#" class="btn">order now</a>
                    </div>
                    <div class="image">
                        <img src="{{asset('frontend/images/home-img-1.png')}}" alt="">
                    </div>
                </div>
                ...
                <div class="swiper-slide slide">
                    ...
                    <div class="image">
                        <img src="{{asset('frontend/images/home-img-2.png')}}" alt="">
                    </div>
                </div>
                ...
                <div class="swiper-slide slide">
                    ...
                    <div class="image">
                        <img src="{{asset('frontend/images/home-img-3.png')}}" alt="">
                    </div>
                </div>
    ...
    <section class="dishes" id="dishes">
        ...
        <h3 class="sub-heading"> our Registered Restaurants</h3>
        ...
        <div class="box-container">
            @foreach( $restaurants as $restaurant)
                <div class="box col-md-8">
                    ...
                    <img src="{{ (!empty($restaurant->image))? url('upload/restaurant_images/'.$restaurant->image):url('upload/no_image.jpg') }}" alt="">
                    <h3>{{$restaurant->name}}</h3>
                    <span>Opening time {{$restaurant->opening_time}}</span>
                    <span>Closing time {{$restaurant->closing_time}}</span>
                    <span>Delivery EST {{$restaurant->delivery_est}}</span>
                    <span>Address {{$restaurant->address}}</span>
                    <a href="{{route('restaurantsmenu',$restaurant->id)}}" class="btn">Start Order</a>
                </div>
            @endforeach
